...
from proda.data.base_dataset import BaseDataset
from proda.data.augmentations import *
from proda.data.DataProvider import DataProvider
...
def create_dataset(opt, logger):
    ...
    Example:
        >>> from proda.data import create_dataset
